...
<html>
    <head>
        ...
        <style>
            .banner-background{
                clip-path: polygon(0 0.8%, 100% 0.8%, 100% 100%, 65% 92%, 30% 100%, 0 92%);
            }
        </style>
    </head>
    <body>
        ...
        <div class="container-fluid m-0 p-0">
            ...
            <div class = "jumbotron primary-background text-white banner-background">
                <div class="container">
                    <h3 class="display-3">Welcome to TechTalk</h3>
                    ...
                    <p>Most programming languages consist of instructions for computers.
                        ...
                        rather than general programming languages.</p>

                    <br>
                    <a href="register_page.jsp" class="btn btn-outline-light btn-lg"><span class="fa fa-user-plus"></span> Start Now! It's Free</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
