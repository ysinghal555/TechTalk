...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark primary-background p-3">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#" data-toggle="modal" data-target="#add-post-modal"><span class="fa fa-upload"></span> Post</a>
                    </li>
        ...
        <!--This is for alert message if our profile gets updated or not-->
        <%
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 ">
                        ...
                        <div class="list-group">
                            <!--here 'this' gives the reference of the link you have clicked to temp variable in getPosts() in ajax-->
                            ...
                            <%
                                ...
                                ArrayList<Category> list1 = d.getAllCatergories();
                    ...
                    <div class="col-md-8" >
                        ...
                        <!--this div is used to show the loader at the starting and we can also call this loader again-->
                        <div class="container text-center" id="loader">
                            <i class="fa fa-refresh fa-3x fa-spin"></i>
                            <h3 class="mt-3">Loading...</h3>
                        </div>

                        <!--here we are using ajax, so that we don't need to refresh the page after the loading page-->
                        <!--and also with ajax we can show load_posts.jsp page on the profile.jsp page without refreshing the current page-->
...
//            this function provides only those post which have catId which is given 
            function getPosts(catId, temp) {  // temp --> reference of the link you have clicked
                ...
                $.ajax({
                    url: "load_posts.jsp",
                    // key-value pair
                    // initially '0' is coming in catId and if there is 0 then we check on the server if '0' or not if '0' then show all posts
                    // check in (load_posts.jsp)
...
//                        hide the loader when data loades from page_posts.jsp
                        $("#loader").hide();
                        $("#post-container").show();
            ...
            $(document).ready(function (e) {
                ...
                // here we are giving (for all posts) if no catId (it means we have to show all posts)
